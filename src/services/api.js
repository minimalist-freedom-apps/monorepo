...
export const fetchCoingeckoRates = async () => {
    try {
        const response = await fetch(`${CORS_PROXY}https://api.coingecko.com/api/v3/exchange_rates`);
...
export const fetchBitpayRates = async () => {
    try {
...
export const fetchBlockchainInfoRates = async () => {
    try {
...
export const fetchAverageRates = async () => {
    try {
        ...
        const allRates = {};
        const sources = [coingecko, bitpay, blockchain].filter(r => r !== null);
