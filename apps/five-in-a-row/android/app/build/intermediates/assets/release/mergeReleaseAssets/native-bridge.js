...
var nativeBridge = (exports => {
    ...
    const createProxyUrl = (url, win) => {
        ...
        const bridgeUrl = new URL(
            (_b = (_a = win.Capacitor) === null || _a === void 0 ? void 0 : _a.getServerUrl()) !==
                null && _b !== void 0
                ? _b
                : '',
        );
    ...
    const initBridge = w => {
        ...
        const initEvents = (win, cap) => {
            cap.addListener = (pluginName, eventName, callback) => {
                ...
                return {
                    remove: async () => {
                        var _a;
                        (_a = win === null || win === void 0 ? void 0 : win.console) === null ||
                        _a === void 0
                            ? void 0
                    ...
                    Object.defineProperty(document, 'cookie', {
                        get: () => {
                            ...
                            if (platform === 'ios') {
                                ...
                                return (_c =
                                    (_b =
                                        (_a = win.CapacitorCookiesDescriptor) === null ||
                                        _a === void 0
                                            ? void 0
                        ...
                        prototype.open = function (method, url) {
                            ...
                            Object.defineProperties(this, {
                                readyState: {
                                    get: function () {
                                        var _a;
                                        return (_a = this._readyState) !== null && _a !== void 0
                                            ? _a
                                            : 0;
                                    },
                                    set: function (val) {
        ...
        function initNativeBridge(win) {
            ...
            cap.isPluginAvailable = name => Object.hasOwn(cap.Plugins, name);
            ...
            cap.toNative = (pluginName, methodName, options, storedCallback) => {
                ...
                try {
                    ...
                    (_b = win === null || win === void 0 ? void 0 : win.console) === null ||
                    _b === void 0
                        ? void 0
                        : _b.error(e);
                }
            ...
            if (win === null || win === void 0 ? void 0 : win.androidBridge) {
                win.androidBridge.onmessage = event => {
